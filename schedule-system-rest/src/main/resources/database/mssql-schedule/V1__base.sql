...
CREATE TABLE subject_class_day (
    subject_class_day_id BIGINT NOT NULL,
    cat_day BIGINT NOT NULL,
    ac_cy_subject_id BIGINT NOT NULL,
    CONSTRAINT subject_class_day_pk PRIMARY KEY (subject_class_day_id)
);
...
ALTER TABLE subject_class_day ADD CONSTRAINT ac_cy_class_day_subject_class_day_fk
...
CREATE SEQUENCE SEQ_SUBJECT_CLASS_DAY START WITH 10000 INCREMENT BY 1;
